					...
					<?php 
						if(isset($_SESSION['id'])){
							...
							<span class='nav-link dropdown'>
								...
								<div class=" position-absolute dropdown-menu text-light rounded bg-dark mt-3" style="z-index: 1;">
									<a href="job-seeker/index.php" class="border-bottom p-2">	<?php 
											echo $_SESSION['email'];
										 ?> 	
									</a>
							...
							echo "<li class='nav-link'><a href='login.php' class=''>Log in</a></li><a href='signup.php' class='nav-link p-2'>Sign Up</a>";
						}
