	...
	<div class="container-fluid">
				...
				<?php
				 ...
				 <?php 
							 		...
							 		<tr>
							 			<td>
							 				<a href="profile.php?user=" class="font-weight-bold"><?php echo $company; ?></a>
							 			</td>
					<!--------------------------- Title  ---------------------------------->
		...
		<a class="text-decoration-none" onclick="<?php 
				$id = $row['id'];

				$s = "SELECT * FROM jobs WHERE id = '{$id}'";
...
href="approval.php?approve=<?php #echo $row['id']; ?>"